...
class ActionChainsMixin:
    ...
    def click(self):
        ...
        self.action_chains.click(self.element)
    ...
    def context_click(self):
        ...
        self.action_chains.context_click(self.element)
        return self.action_chains

    def double_click(self):
        Log.info('Double-clicks an "%s" element.' % self.element_name)
        self.action_chains.double_click(self.element)
        return self.action_chains
    ...
    def drag_and_drop(self, destination: BaseElement):
        ...
        self.action_chains.drag_and_drop(self.element, destination.find())
        return self.action_chains
    ...
    def drag_and_drop_by_offset(self, xoffset, yoffset):
        ...
        self.action_chains.drag_and_drop_by_offset(self.element, xoffset, yoffset)
        return self.action_chains

    def key_down(self, value):
        Log.info('Sends a key press only, without releasing it')
        self.action_chains.key_down(value, self.element)
        return self.action_chains

    def key_up(self, value):
        Log.info('Releases a modifier key.')
        self.action_chains.key_up(value, self.element)
        return self.action_chains

    def move_by_offset(self, xoffset, yoffset):
        Log.info('Moving the mouse to an offset from current mouse position.')
        self.action_chains.move_by_offset(xoffset, yoffset)
        return self.action_chains
